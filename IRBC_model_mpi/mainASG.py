...
parser.add_argument(
    "--final_grid", dest="load_flag", action="store_true", help="Postprocessing only"
)
...
if args.load_flag:
    ...
    for iter0 in range(numstart, maxiter + 1):
        ...
        polGuess1 = copy.copy(polGuess[:grid1.getNumNeeded(),:])        
        ...
        print(
            "Iteration: %2d, Grid pts: %2d, Level: %2d, Metric: %.4E"
            % (iter0, grid0.getNumPoints(), ilev, metric)
        )
